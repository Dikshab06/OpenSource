                        ...
                        <form method="post" action="{{ route('supplier.update') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    value="{{ $supplier->code }}" type="number">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    value="{{ $supplier->address1 }}" type="text">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    value="{{ $supplier->address2 }}" type="text">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <option id="iValor" atr_inputOption="{{ $supplier->postalCode }}"
                                    selected=""></option>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#1bLocation').text("");
        $('#1bLocation').text($("#codePostal option:selected").attr("atrLocation"));
